...
// `cn` (shadcn) absent du projet : concatenation simple suffit ici.
const cn = (...c: (string | false | null | undefined)[]) => c.filter(Boolean).join(" ");

// `MotionSubtitle` non fourni avec le composant. Rendu par un <span> : il ne
// portait qu'un sous-titre animé, la légende de la roue le fait déjà.
const MotionSubtitle = ({ children, className }: { children?: ReactNode; className?: string; [k: string]: unknown }) =>
            ...
            {images.map((img, i) => (
              ...
              >
                <div
                  ...
                  // Guillemets obligatoires : les noms de fichiers photo contiennent des
                  // espaces, et `url(/photos/AB X ....jpeg)` non quoté est du CSS
                  // invalide — le fond restait vide.
